 ...
 */
public class SJasperReportsResult extends StrutsResultSupport implements JasperReportConstants {
     ...
     */
    public SJasperReportsResult(String location) {
        super(location);
    }
    ...
    /**************************************************************************************************************/
    private void initParams( ActionInvocation invocation ){
    	ValueStack stack = invocation.getStack();
    	JasperResultBean bean = (JasperResultBean)stack.findValue(JasperResultBean.JASPER_RESULT_BEAN, JasperResultBean.class);
    	
    	this.setConnection(JasperResultBean.JASPER_CONN);
    	this.setDataSource(JasperResultBean.JASPER_DATASOURCE);
    	this.setReportParameters(JasperResultBean.JASPER_REPORT_PARAMS);
    	
    	this.setImageServletUrl(bean.getImageServletUrl());
    ...
    protected void doExecute(String finalLocation, ActionInvocation invocation) throws Exception {
        ...
        if(finalLocation==null){
        	//Log.error("jasper finalLocation is null................. ");
        ...
        //ETag	W/"553742-1421740828874"
        //Last-Modified	Tue, 20 Jan 2015 08:00:28 GMT
